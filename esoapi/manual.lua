...
function ZO_CreateStringId(id, value, version) end
...
function ZO_CallbackObjectMixin:Subclass() end
...
function ZO_PrioritizedVisibility:Add(objectToControl, priority, categoryFlags, descriptor) end
...
function ZO_PrioritizedVisibility:GetObjectInfo(object) end
