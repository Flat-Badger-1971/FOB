...
function CompassDisplayControl:SetPinInfo(pinType, pinSize, pinTexture, areaTexture, aboveTexture, belowTexture,
                                          ...
                                          removedAnimation, layer, drawLevelOffsetBase)
end
...
function SliderControl:SetThumbTextureAndFlush(filename, disabledFilename, highlightedFilename, thumbWidth, thumbHeight,
                                               texTop, texLeft, texBottom, texRight, flush)
end
...
function TooltipControl:SetActiveSkill(skillType, skillLineIndex, skillIndex, morphSlot, isPurchased, isAdvised,
                                       ...
                                       showAdvised, showBadMorph, overrideRank, overrideAbilityId)
end
...
function TooltipControl:SetCraftedAbilityScript(craftedAbilityId, craftedAbilityScriptId, primaryScriptId,
                                                secondaryScriptId, tertiaryScriptId, displayFlags)
end
...
function TooltipControl:SetPassiveSkill(skillType, skillLineIndex, skillIndex, rank, purchasedToRank,
                                        numAvailableSkillPoints, showSkillPointCost)
end
...
function TooltipControl:SetPendingAlchemyItem(solventBagId, solventSlotIndex, reagent1BagId, reagent1SlotIndex,
                                              reagent2BagId, reagent2SlotIndex, reagent3BagId, reagent3SlotIndex)
end
...
function TooltipControl:SetPendingEnchantingItem(potencyRuneBagId, potencyRuneSlotIndex, essenceRuneBagId,
                                                 essenceRuneSlotIndex, aspectRuneBagId, aspectRuneSlotIndex)
end
...
--- @field Texture Control
--- @field Label Control
--- @field FadeAnimation AnimationTimeline
--- @field Animation AnimationTimeline
TopLevelWindow = {}
--- @return boolean allow
