...
ZO_CreateStringId("FOB_PREVENT_LOREBOOKS", "Prevent reading a lorebook")
ZO_CreateStringId("FOB_PREVENT_MUSHROOM", "Prevent mushroom gathering")
ZO_CreateStringId("FOB_PREVENT_MAGES_GUILD", "Prevent entering a Mages Guild")
ZO_CreateStringId("FOB_PREVENT_NIRNROOT", "Prevent gathering Nirnroot")
ZO_CreateStringId("FOB_PREVENT_EDICTS", "Prevent using edicts")
-- ZO_CreateStringId("FOB_PREVENT_EDICTS_DC", "Block double clicking an edict")
-- ZO_CreateStringId("FOB_PREVENT_EDICTS_DC_TT", "After unsetting this value, you must reload the UI for it to take effect.")
ZO_CreateStringId("FOB_PREVENT_FENCE", "Prevent fencing stolen items")
